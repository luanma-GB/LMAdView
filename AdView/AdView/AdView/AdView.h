...
@property (strong,nonatomic) NSMutableArray * imageLinkURL;
@property (strong,nonatomic) NSArray * imageModels;
@property (retain,nonatomic) NSMutableArray * adTitleArray;
/**
 *  @author ZY, 15-05-17
 *
 *  设置page显示位置
...
@property (nonatomic,strong) void (^callBack)(NSInteger index,id info);
 ...
 *  @param imageModels          <#imageModels description#>
 *  @param imageName            <#imageName description#>
 *  @param PageControlShowStyle <#PageControlShowStyle description#>
 *
 *  @return 广告视图
 */
+ (id)adScrollViewWithFrame:(CGRect)frame imageModels:(NSArray *)imageModels placeHoderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle;
@end
